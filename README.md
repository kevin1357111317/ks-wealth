...
也不是除權息或拆股。修正後全期（2019-10-23 ~ 2026-09-17）累積 TWR 從 206.18% 回到 471.24%、年化 TWR
從 17.59% 回到 28.70%；XIRR 27.09% 完全不變 —— XIRR 是資金加權，本來就該用台帳的真實現金金額，所以
...
「—」，沒有把短期報酬放大年化過）；期間剛好一年（365–366 天）時年化必然等於累積，標「期間為一年，
